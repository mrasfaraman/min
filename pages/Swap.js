...
const Swap = ({navigation}) => {
  ...
  const convertTop = async event => {
    ...
    let calculate = topUSDValue?.amount * Number(text);
  ...
  const convertbottom = async event => {
    ...
    let calculate = bottomUSDValue?.amount * Number(text);
  ...
  const swap = () => {
    if (activeNet?.type == 'solana') {
      let trxData = {
        ...
        amountWei: topValue * Math.pow(10, topToken?.decimals),
      };
        ...
        <Modal
          ...
          <View
            ...
            <View
              ...
              <TouchableOpacity
                onPress={async () => {
                  await navigation.navigate('AddToken');
                  setModalVisible(!modalVisible);
                }}>
          ...
          <>
            ...
            <View style={styles.amountWrapper}>
              <View style={styles.amountInpWrapperFlex}>
                ...
                <Text style={[styles.amountSwapValue, {color: theme.text}]}>
                  -
                </Text>
              </View>
            </View>
          ...
          <>
            <View style={[styles.swapHeaderFlex]}>
              <TouchableOpacity
                ...
                <View style={styles.dropDownFlex}>
                  <Text style={[styles.swapHeaderText, {color: theme.text}]}>
                    {topToken?.coingekoId || topToken?.name}
                  </Text>
                  <View style={styles.swapLeftSubFlex}>
                    <View>
                      <Image source={SwapDrop} />
              ...
              <View style={styles.amountInpWrapperFlex}>
                <View style={styles.amountImageLeftFlex}>
                  <View>
                    <Image
                      style={styles.pancakeLeftImage}
                      source={{uri: topToken?.logo || topToken.logoURI}}
                    />
                  </View>
                  <Text style={[styles.amountSwapLable, {color: theme.text}]}>
                    {topToken?.coingekoId || topToken?.symbol}
                  </Text>
                </View>
                {/* <TextInput
                ...
                <TextInput
                  ...
                  style={[
                    styles.amountSwapValue,
                    {color: theme.text, width: '50%', textAlign: 'right'},
                  ]}
                  // value={topValue}
                  onChange={convertTop}
                  keyboardType="numeric"
                    ...
                    <View
                      ...
                      <View style={styles.pancakeCardLeft}>
                        <View
                          ...
                          <Image
                            style={styles.pancakeLeftImage}
                            source={{uri: item.logo || item.logoURI}}
                          />
                        </View>
                      </View>
                      <View style={styles.pancakeCardRight}>
          ...
          <>
            <View style={[styles.swapHeaderFlex]}>
              <TouchableOpacity
                ...
                <View style={styles.dropDownFlex}>
                  <Text style={[styles.swapHeaderText, {color: theme.text}]}>
                    {bottomToken?.coingekoId || bottomToken?.name}
                  </Text>
                  <View style={styles.swapLeftSubFlex}>
                    <View>
                      <Image source={SwapDrop} />
            ...
            <View style={[styles.amountInpWrapperFlex, {marginTop: 15}]}>
              <View style={styles.amountImageLeftFlex}>
                <View>
                  <Image
                    style={styles.pancakeLeftImage}
                    source={{uri: bottomToken?.logo || bottomToken?.logoURI}}
                  />
                </View>
                <Text style={[styles.amountSwapLable, {color: theme.text}]}>
                  {bottomToken?.coingekoId || bottomToken?.symbol}
                </Text>
              </View>
        ...
        <View>
          <View style={[styles.swapWrapper]}>
            ...
            <View style={styles.swapBtnFlexWrapper}>
              <TouchableOpacity
                onPress={() => {
                  setTopToken(bottomToken), setBottomToken(topToken);
                }}
          ...
          <View
            ...
            <View style={styles.gasFeeFlex}>
              ...
              <Text style={[styles.gasFee, {color: theme.emphasis}]}>
                {bottomValue ? bottomValue : 0} {bottomToken?.symbol}
              </Text>
            </View>
            <View style={styles.gasFeeFlex}>
              <Text style={[styles.gasFeeLabel, {color: theme.text}]}>
            ...
            <View style={styles.gasFeeFlex}>
              ...
              <Text style={[styles.gasFee, {color: theme.emphasis}]}>
                {address?.replace(/^"|"$/g, '').substring(0, 30)}
              </Text>
            </View>
          </View>
